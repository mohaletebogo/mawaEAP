...
import za.raretag.mawa.entities.ChangeLog;
...
public class ChangeLogJpaController implements Serializable {
    ...
    public ChangeLogJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(ChangeLog changeLog) throws RollbackFailureException, Exception {
    ...
    public void edit(ChangeLog changeLog) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
            ...
            if (msg == null || msg.length() == 0) {
                Integer id = changeLog.getChangeId();
